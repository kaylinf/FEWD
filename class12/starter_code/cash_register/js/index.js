$(document).ready(function(){
	...
	function currencyFormat(numberToConvert){
		...
		//Take the number that was passed to the currencyFormat function and make sure that it has two decimal points
		var currency = numberToConvert.toFixed(2);

		//Add dollar sign to the decimal number we just created. This will convert the number to a string.
